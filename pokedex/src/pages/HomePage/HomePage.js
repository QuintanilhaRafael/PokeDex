...
function HomePage() {
  ...
  const { nameNumberQuery, typeQuery, selected, isLoading, error, pokemonsData, playPcOn, playAPress, listPageNumber, setListPageNumber, playCompletedDex, storedDex, catchAllOfThem } = useContext(GlobalStateContext)
  ...
  return (
    <PageContainer>
      ...
      <Header>
        <PageTitle>
          <img onClick={() => { goToHomePage(navigate); playAPress(); catchAllOfThem()}} src={pokeball} alt="pokeball" />
